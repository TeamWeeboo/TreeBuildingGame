...
public class SeedLibrary:MonoBehaviour {
	...
	public GameObject previewAreaObject;
	public Material previewMaterial;

	private void Awake() {
		CommandData.InitStatic(previewMaterial,previewAreaObject);
		if(!DeletButton) DeletButton=ScriptableObject.CreateInstance<RemoveCommand>();
